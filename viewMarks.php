...
?>
<p style="font-size:large;text-align:left;color:gray;font-weight:bold;">Welcome <?php echo $student_name;?></p>
<form method="post" action="viewMarksDetails.php" >
	<fieldset style="width:50%;">
	<legend style="font-size:xx-large;text-align:left;color:gray;font-weight:bold;">View Marks</legend>
		<table>
			<tr>
			...
			<tr>
				<td><input type="submit" value="View Marks"/></td><td><input type="reset" /></td>				
			</tr>
		</table>
	</fieldset>
</form>	
